/**
 * Master list of all supported interface languages.
 * This must match the locales in /public/locales/ and the crowdin.yml config.
 *
 * When Crowdin hasn't provided translations yet for a language, i18next
 * will automatically fall back to `en` (as configured in i18n.ts).
 */
