    ...
    <header className="px-4 lg:px-12 py-4 shrink-0 border-b border-border-subtle bg-background">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div className="flex flex-col gap-0.5">
          <Link to="/home" className="flex items-center gap-2 hover:opacity-85 transition-opacity cursor-pointer group">
        ...
        <div className="flex flex-row items-center gap-2">
          {/* Advanced Search shortcut — active for all search tabs */}
          <Button
            variant="ghost"
          ...
          <Button
            ...
            aria-current={activeTab === "countries" ? "page" : undefined}
            className={cn(
              "text-text-secondary hover:text-text-body hover:bg-surface-2 rounded-xl transition-all gap-2 border border-transparent",
